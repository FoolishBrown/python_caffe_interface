...
#matplotlib.use("Pdf")
import cv2
#caffe_root = 'G:/caffe/caffe-master/caffe-master'  #change to your caffe root path
#import sys
...
class FaceDetector(object):
    ...
    def __init__(self,
        ...
        sourpath=r'E:\validation\lab_code\MTCNN_face_detection_caffe-master\model'
        model_P = sourpath+'\\det1.prototxt'
        weights_P = sourpath+'\\det1.caffemodel'
        model_R = sourpath+'\\det2.prototxt'
        weights_R = sourpath+'\\det2.caffemodel'
        model_O =sourpath+'\\det3.prototxt'
        weights_O =sourpath+'\\det3.caffemodel'
...
# 
#    img = cv2.imread('G:/FaceTools-release/test/1732800/001.jpg')
